    ...
    <div className='p-10 bg-gradient-to-br bg-black flex flex-col justify-center items-center text-white'>
       ...
       <div className='w-full flex justify-center'>
          <div className='flex gap-2 items-center p-2 border rounded-md my-5 w-[50%]'>
            <Search/>
            <input type="text" placeholder='search' className='bg-transparent placeholder:text-gray-400 w-full outline-none' onChange={(event)=>onSearchInput(event.target.value)}/>
          </div>
       </div>
    </div>
  )
